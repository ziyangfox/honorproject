...
MySQL - 5.7.18-log : Database - onlyzaixianshangcheng
*********************************************************************
*/
...
CREATE TABLE `cart` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1701943732584 DEFAULT CHARSET=utf8 COMMENT='购物车表';

/*Data for the table `cart` */

insert  into `cart`(`id`,`addtime`,`tablename`,`userid`,`goodid`,`goodname`,`picture`,`buynumber`,`price`,`discountprice`) values (1701943732583,'2023-12-07 18:08:52','shangpinxinxi',11,44,'时尚气质舒适高腰直筒九分牛仔裤','http://localhost:8080/ONLYzaixianshangcheng/upload/1617280380217.jpg',1,324.4,0);
...
CREATE TABLE `shangpinpingjia` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1701946868526 DEFAULT CHARSET=utf8 COMMENT='商品评价';

/*Data for the table `shangpinpingjia` */

insert  into `shangpinpingjia`(`id`,`addtime`,`dingdanbianhao`,`shangpinmingcheng`,`shangpinfenlei`,`pinpai`,`pingfen`,`pingjianeirong`,`tianjiatupian`,`pingjiariqi`,`yonghuming`,`lianxidianhua`,`sfsh`,`shhf`) values (1701946868525,'2023-12-07 19:01:07','20214120444748704272','时尚修身显瘦小黑裙两件套连衣裙','裙装','品牌1','3','还行','http://localhost:8080/ONLYzaixianshangcheng/upload/1701946858719.jpg','2023-12-19','111','13823888881','否',NULL);
...
CREATE TABLE `storeup` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1701946648694 DEFAULT CHARSET=utf8 COMMENT='收藏表';
...
insert  into `token`(`id`,`userid`,`username`,`tablename`,`role`,`token`,`addtime`,`expiratedtime`) values (1,11,'用户1','yonghu','用户','itqj3qtzp5y76ok34yybrt9s1cmab4vm','2021-03-13 16:04:27','2023-12-08 00:31:30'),(2,1,'abo','users','管理员','jujwjh90yoyxj2qil9z41vc9qi66gwnj','2021-03-13 16:05:48','2023-12-07 12:04:55'),(3,1614241036888,'1','yonghu','用户','w59s1pisbi8g0x8b2ur0mwjdewf0lepf','2021-03-13 16:18:05','2021-03-13 09:22:12');
...
insert  into `users`(`id`,`username`,`password`,`role`,`addtime`) values (1,'java1234','admin','管理员','2021-03-13 15:59:12');
